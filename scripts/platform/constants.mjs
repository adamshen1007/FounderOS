...
export const PLATFORM_LOCAL_FILE = resolve(ROOT, ".founderos", "platform", "local-workspace.yaml");
export const PLATFORM_BACKUP_DIRECTORY = resolve(ROOT, ".founderos", "platform", "backups");
